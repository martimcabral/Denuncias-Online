						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<h5 class="mb-0">Lista de Denúncias do Ano Escolar <?php echo $anoescolar ?>
									<a href="<?php echo $link . $Dir_Denuncias . 'DenunciasCriar.php' ?>" title="Adicionar nova denúncias">
                                ...
                                <?php
                                   $ESTADO = $_GET['estado'];
                                    ...
                                    $sql = "SELECT * FROM denuncias WHERE estado = $ESTADO AND id_azores_escola = '$IdAzoresEscola' ORDER BY id DESC";
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            $sql_nome = "SELECT * FROM utilizadores WHERE id =" . $row['utilizador'];
                                            ...
                                            echo "<tr>
                                                ...
                                                <td align='center'>
                                                    <a href='" . $linkDir_Denuncias . "Denuncias_Responder.php?ticket=" . $row["numero_ticket"] . "'>
                                                        <button class='btn btn-sm btn-outline-light'>
                                                            <img title='Responder este Ticket' src='../Images/Icons/RN_parcial.png' height='17px' width='17px'/>
                                                        </button>
                                                    </a>";
                                            echo "</td>
                                            </tr>";
