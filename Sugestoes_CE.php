						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<h5 class="mb-0">Lista de Sugestões Abertas <?php echo $anoescolar ?></h5>
                                ...
                                <?php
                                   $ESTADO = $_GET['estado'];
                                    ...
                                    $sql = "SELECT * FROM sugestoes_rgpc WHERE estado = $ESTADO AND id_azores_escola = '$IdAzoresEscola' ORDER BY id DESC";
