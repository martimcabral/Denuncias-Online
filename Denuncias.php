						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<h5 class="mb-0">Lista das minhas denúncias do ano escolar <?php echo $anoescolar ?>
									<a href="<?php echo $link . $Dir_Denuncias. 'DenunciasCriar.php' ?>" title="Adicionar nova denúncia">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM denuncias WHERE utilizador = '$IdDoUtilizador' AND id_azores_escola = '$IdAzoresEscola' ORDER BY id DESC";
                                    ...
                                    echo "<tr>
                                            ...
                                            <th style='width=40px'>Data de Criação</th>
                                            <th>Opções</th>
                                        </tr>";
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            echo "<tr>
                                                ...
                                                <td align='center'>
                                                    <a href='" . $linkDir_Denuncias . "Denuncias_Consultar.php?ticket=" . $row["numero_ticket"] . "'>
                                                        <button class='btn btn-sm btn-outline-light'>
                                                            <img title='Consultar esta Denúncia' src='../Images/Icons/RN_parcial.png' height='17px' width='17px'/>
                                                        </button>
                                                    </a>";
                                            echo "</td>
                                            </tr>";
