                                  ...
                                  <h5 class="card-header">Denúncias</h5>
                                    <div class="card-body"> 
                                        ...
                                        <div class="form-group">
                                            <label for="inputText3" class="col-form-label">A sua Denúncia:</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea readonly name="resposta" class="form-control" rows="10" id="des" required style="resize: none;" maxlength="3000"><?php if ($row["resposta"] == null) {echo 'Nenhuma Resposta até agora.';} else {echo htmlspecialchars($row['resposta']);}?></textarea>
                                        </div>
