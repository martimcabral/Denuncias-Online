				...
				<div class="dashboard-short-list">
					   <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                  <h5 class="card-header">Denúncia</h5>
                                    <div class="card-body"> 
										<form action="DenunciasNovo.php" multipart="/form-data" method="POST">	
											...
											<div class="col-sm-6 pl-0">
												<p class="text-right">
													<button type="submit" name="gravar_novo_ticket" class="btn btn-space btn-primary">Reportar Denuncia</button>
												</p>
											</div>	
										</form>
                                    </div>
