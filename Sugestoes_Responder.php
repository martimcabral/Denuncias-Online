                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                  <h5 class="card-header">Sugestão</h5>
                                    <div class="card-body"> 
										<form action="Sugestoes_EnviarResposta.php" multipart="/form-data" method="POST">	
                                            ...
                                            <?php 
                                                ...
                                                $stmt = $conn->prepare("SELECT * FROM sugestoes_rgpc WHERE numero_ticket = ?");
                                            ...
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Decreva a Sugestão</label>
											...
											<div class="col-sm-6 pl-0">
												<p class="text-right">
                                                <p>Fechado a: <?php echo $row["data_fechado"] ?></p>
