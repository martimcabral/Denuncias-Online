                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        <li class="nav-item dropdown nav-user">
							<a class="nav-link nav-user-img" href="<?php echo $link.$Dir_Sugestoes; ?>Sugestoes.php">Voltar</a>
                        </li>
						<li class="nav-item dropdown nav-user">
				...
				<div class="dashboard-short-list">
					   <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                  <h5 class="card-header">Sugestão</h5>
                                    <div class="card-body"> 
										<form action="SugestoesNovo.php" multipart="/form-data" method="POST">	
											<div class="form-group">
												<label for="inputText3" class="col-form-label">Decreva</label>
												...
												<textarea name="descricao" class="form-control" rows="10" id="des" required style="resize: none;" maxlength="3000"></textarea>
											</div>
											<div class="col-sm-6 pl-0">
												<p class="text-right">
													<button type="submit" name="gravar_novo_ticket" class="btn btn-space btn-primary">Reportar Sugestão</button>
												</p>
											</div>	
										</form>
                                    </div>
